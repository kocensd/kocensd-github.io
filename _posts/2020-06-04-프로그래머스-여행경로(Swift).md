...
func solution1(_ tickets:[[String]]) -> [String] {
    ...
    func dfs(_ depth: Int, _ startPoint: String, _ ticket: [[String]], _ answer: inout [String], _ visited: inout [Bool], _ arr: inout [String]) {
        ...
        for i in 0..<ticket.count  {
            let infomation: (start: String, end: String) = (ticket[i][0], ticket[i][1])

            if visited[i] == false && startPoint == infomation.start {
                visited[i] = true
                dfs(depth+1, infomation.end, ticket, &answer, &visited, &arr)
                visited[i] = false
            }
        }
        arr.removeLast()
    ...
    dfs(0, "ICN", tickets, &answer, &visited, &arr)
